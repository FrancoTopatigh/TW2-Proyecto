...
import { CrearUsuarioRequest } from '../../../modules/usuarios/interface/usuario.interface';
import { LoginResponse } from '../../../modules/usuarios/interface/login.interface';
import { Usuario } from '../../../modules/usuarios/interface/usuario.interface.rest';
...
export class AuthService {
  ...
  registrar(data: CrearUsuarioRequest): Observable<Usuario> {
